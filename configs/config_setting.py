...
class setting_config:
    ...
    datasets = 'BraTs2020_t1_t2_small' 
    if datasets == 'BraTs2020_t1_t2_small':
        data_path = 'datasets/BraTs2020_t1_t2_small/'
    else:
    ...
    work_dir = 'results/' + network + '_' + datasets + '_' + 'x' + str(upscale) + '_' + datetime.now().strftime('%A_%d_%B_%Y_%Hh_%Mm_%Ss') + '/'
    ...
    if opt == 'Adadelta':
        ...
        lr = 0.0001 # default: 1e-4 – learning rate
        betas = (0.9, 0.999) # default: (0.9, 0.999) – coefficients used for computing running averages of gradient and its square
        eps = 1e-8 # default: 1e-8 – term added to the denominator to improve numerical stability
