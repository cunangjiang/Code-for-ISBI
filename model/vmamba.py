...
class STVSSBlock(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.self_attention = STSS2D(d_model=hidden_dim, dropout=attn_drop_rate, d_state=d_state, is_cross=is_cross, **kwargs)
    ...
    def forward(self, input: torch.Tensor, style=None):
        ...
        if style is not None:
            ...
            style = style[:,indexes,:]
        x = input + self.drop_path(self.self_attention(self.ln_1(input), style=style))
        return x
